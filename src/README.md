...
- `js/router.js`: navegacion hash sin recargar la pagina.
...
Abre `index.html` directamente en el navegador. No requiere servidor, dependencias, modulos ES ni proceso de build.
